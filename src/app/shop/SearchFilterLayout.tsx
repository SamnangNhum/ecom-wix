...
export default function SearchFilterLayout({ collections, children }: SearchFilterLayoutProps) {
...
function CollectionsFilter({ collections, selectedCollectionIds, updateCollectionIds }: CollectionsFilterProps) {
    return (
...
function PriceFilter({ maxDefaultInput, minDefaultInput, updatePriceRange }: PriceFilterProps) {
