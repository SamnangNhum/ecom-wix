...
export default async function Page({ searchParams: { q, page = "1", collection: collectionIds, price_min, price_max, sort } }: PageProps) {
...
async function ProductResults({ q, page, collectionIds, priceMin, priceMax, sort }: ProductResultsProps) {
    ...
    return <div className="space-y-10 group-has-[[data-pending]]:animate-pulse">
