...
export async function queryProducts(wixClient: WixClient,{q,collectionIds,sort="last_updated",priceMin,priceMax,skip,limit}:QueryProductsFilter) {
...
export async function getRelatedProducts(wixClient:WixClient,productId:string){
