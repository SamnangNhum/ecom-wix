...
export async function addToCart(wixClient: WixClient, {product,selectedOptions,quantity}:AddToCartValues){
        ...
        lineItems:[
            {
                catalogReference:{
                    ...
                    options:selectedVariant ? {variantId:selectedVariant._id} : {options:selectedOptions}
                },
                quantity,
            }
        ]
